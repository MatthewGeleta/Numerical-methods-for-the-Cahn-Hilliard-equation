function [cvecs, t, itvec] = CH2D14(N,T,ep,mu,seed,k)   
%{
CH2D14 computes the solution two two-dimensional Cahn-Hilliard equation with Neumann
boundary conditions using scheme (d) in "Numerical Methods for the
...
%}
    ...
    f2 = @(cn,co,wn) wn - cn.^3 + co + (ep^2/h^2)*D*cn;
